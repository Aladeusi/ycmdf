            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="icon-magnet icon-c-logo"></i><span>FINNESEHACKER</span></a>
                        <!-- Image Logo here -->
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                             ...
                             <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect">
                                    <i class="fa fa-arrow-left" aria-hidden="true"></i>
                                 <span> Manage category</span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{route('admin.category.create')}}">Add</a></li>
                                    <li><a href="{{route('admin.category.list')}}">View</a></li>
                                </ul>
                            </li>
